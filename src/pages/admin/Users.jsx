/**
 * AdminUsers.jsx
 * Panel de administración de usuarios con aprobación
 */

import { useState, useEffect } from 'react';
import { Users, Check, X, Search, Loader, UserPlus, UserMinus } from 'lucide-react';
...
export default function AdminUsers() {
    ...
    const rechazarUsuario = async (userId) => {
        ...
        setUsuarios(prev => 
            prev.map(u => u.id === userId ? { ...u, estado: 'RECHAZADO' } : u)
        );
    };
    ...
    const usuariosFiltrados = usuarios.filter(u => {
        const matchesSearch = !search || 
            ...
            u.puesto_numero?.includes(search);
                        ...
                        >
                            <div className="flex items-start justify-between">
                                <div className="flex-1">
                                    ...
                                    <p className="text-gray-500 text-sm">
                                        🏪 Puesto: {usuario.puesto_numero || 'No asignado'}
                                    </p>
